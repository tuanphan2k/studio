    ...
    <div className="container py-12 md:py-16">
      ...
      <Card className="max-w-4xl mx-auto">
        <CardContent className="p-8 md:p-10 prose max-w-none dark:prose-invert">
          <h2 className="font-bold mt-8">1. Chấp Nhận Điều Khoản</h2>
          ...
          <h2 className="font-bold mt-8">2. Sử Dụng Dịch Vụ</h2>
          <p className="text-indent-8">
          ...
          <h2 className="font-bold mt-8">3. Quyền Sở Hữu Trí Tuệ</h2>
          <p className="text-indent-8">
          ...
          <h2 className="font-bold mt-8">4. Giới Hạn Trách Nhiệm</h2>
          <p className="text-indent-8">
          ...
          <h2 className="font-bold mt-8">5. Quyền Riêng Tư</h2>
          <p className="text-indent-8">
          ...
          <h2 className="font-bold mt-8">6. Luật Điều Chỉnh</h2>
          <p className="text-indent-8">
          ...
          <h2 className="font-bold mt-8">7. Thay Đổi Điều Khoản</h2>
          <p className="text-indent-8">
